...
/* ----------------------------------------------------------------------------------------------------------------------------- */
/* Board Definition for RaspberryPi 3                                                                                            */
/* ----------------------------------------------------------------------------------------------------------------------------- */
#define VS10XX_MAX_DEVICES 1

#define VS10XX_SPI_CTRL "vs10xx-ctrl"
#define VS10XX_SPI_DATA "vs10xx-data"
#define VS10XX_GPIO_RST  26  // GPIO 26 for Reset
#define VS10XX_GPIO_DREQ 13  // 19  // GPIO 19 for dReq
